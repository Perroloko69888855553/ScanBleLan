...
def crearTabla(db,db_name,db_table):
    ...
    db.ejecutarQuery( tabla_query + " (address VARCHAR(255) NOT NULL, name VARCHAR(255) NULL , description VARCHAR(255) NULL , date_scan DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (address))")
